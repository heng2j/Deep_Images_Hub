...
def create_image_dataframe(row):
    ...
    imageArrayToStruct(img_array)

    return imageArrayToStruct(img_array) , row.label
...
if __name__ == '__main__':
    ...
    schema = StructType([StructField("image", ImageSchema), StructField("filePath", StringType(), False)])
